...
# Demo examples to call the function
#--------------------------------------------
...
# commented to enable compilation of R-Markdown output
# fn.checkprime('a') 
...
print('installation of RTools for compilation of the package - The package mentioned in the assignment question will be compiled and uploaded  to the git url. ')
